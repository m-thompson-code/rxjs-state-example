...
import { catchError, distinctUntilChanged, EMPTY, map, merge, scan, shareReplay, startWith, Subject, switchMap, takeUntil, tap } from 'rxjs';
...
export class StateAltService {
  ...
  private readonly postsAction$ = this.setPosts$.pipe(map(page => ({ value: page, type: 'posts-loaded' as const })));
